...
for(let i=0; i<option.length;i++){
  ...
  document.querySelector('.lien p #pinterest').href =`https://pinterest.com/pin/create/button/?url=https://loca-local.fr/&media=https://loca-local.fr/image/${reponsesFinales[num].image}.png`;
